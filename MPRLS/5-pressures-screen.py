...
while True:
    ...
    draw.rectangle((0, 0, oled.width, 48), outline=0, fill=0)

    draw.text((x, top),       "1: " + str(round(mpr0.pressure, 3)), font=font, fill=255)
    draw.text((x, top+8),     "2: " + str(round(mpr1.pressure, 3)), font=font, fill=255)
    draw.text((x, top+16),    "3: " + str(round(mpr2.pressure, 3)), font=font, fill=255)
    draw.text((x, top+24),    "4: " + str(round(mpr3.pressure, 3)), font=font, fill=255)
    draw.text((x, top+32),    "5: " + str(round(mpr4.pressure, 3)), font=font, fill=255)
    draw.text((x, top+40),    "t: " + str(round(time.time()*1000)) + " s",  font=font, fill=255)
