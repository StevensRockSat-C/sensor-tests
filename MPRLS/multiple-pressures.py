...
mpr0 = adafruit_mprls.MPRLS(multi[3], psi_min=0, psi_max=25)
mpr1 = adafruit_mprls.MPRLS(multi[4], psi_min=0, psi_max=25)

# Setup CSV headers
print("Time(ms),Pressure 0(hPa),Pressure 1(hpa)")
